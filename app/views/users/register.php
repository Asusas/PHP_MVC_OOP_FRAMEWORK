            ...
            <form action="<?php echo URLROOT ?>/users/register" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="repeat_password"
                        ...
                        value="<?php echo $data['repeat_password'] ?>">
                    <span class="invalid-feedback"><?php $data['confirm_password_error']?></span>
                </div>

                <div class="row">
                    <div class="col">
                        <input type="submit" value="Register" class="btn btn-success btn-block btn-sm">
                    </div>
                    <div class="col">
                        <a href="<?php echo URLROOT ?>/users/login" class="btn btn-light btn-block btn-sm">Have an
                            account?
                            Login</a>
                    </div>
                </div>
